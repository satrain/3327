...
<main>
    ...
    <div class="projects-wrapper">
        <!-- Scriptarnica -->
        <div class="slide scriptarnica-slide projects-container">
            <div class="figure-mock scriptarnica-mock">
                <div class="scriptarnica-image1"></div>
                <div class="scriptarnica-image2"></div>
                <div class="scriptarnica-image3"></div>
            </div>
            <div>
                <h3>Scriptarnica</h3>
        ...
        <!-- Bizzllet -->
        <div class="slide bizzllet-slide projects-container">
            <div class="figure-mock bizzllet-mock">
                <div class="bizzllet-image1"></div>
                <div class="bizzllet-image2"></div>
            </div>
            <div>
                <h3>Bizzllet</h3>
        ...
        <div class="slide sbsk-slide projects-container">
            <div class="figure-mock sbsk-mock">
                <div class="sbsk-image1"></div>
                <div class="sbsk-image2"></div>
            </div>
            <div>
        ...
        <!-- Stealth DEX PoC L2  -->
        <div class="slide sdpl-slide projects-container">
            <div class="figure-mock sdpl-mock">
                <div class="sdpl-image1"></div>
                <div class="sdpl-image2"></div>
            </div>
            <div>
        ...
        <!-- Whollet -->
        <div class="slide whollet-slide projects-container">
            <div class="figure-mock whollet-mock">
                <div class="whollet-image1"></div>
                <div class="whollet-image2"></div>
                <div class="whollet-image3"></div>
            </div>
            <div>
                <h3>Whollet</h3>
        ...
        <div class="slide scvd-slide projects-container">
            <div class="figure-mock scvd-mock">
                <div class="scvd-image1"></div>
                <div class="scvd-image2"></div>
            </div>
            <div>
        ...
        <!-- Crypto Gift Cards -->
        <div class="slide cgc-slide projects-container">
            <div class="figure-mock cgc-mock">
                <div class="cgc-image1"></div>
                <div class="cgc-image2"></div>
            </div>
            <div>
        ...
        <!-- Crypto Trophies -->
        <div class="slide crypto-trophies-slide projects-container">
            <div class="figure-mock crypto-trophies-mock">
                <div class="crypto-trophies-image1"></div>
                <div class="crypto-trophies-image2"></div>
            </div>
            <div>
        ...
        <!-- Liquid Crystal  -->
        <div class="slide liquid-crystal-slide projects-container">
            <div class="figure-mock liquid-crystal-mock">
                <div class="liquid-crystal-image1"></div>
                <div class="liquid-crystal-image2"></div>
            </div>
            <div>
        ...
        <!-- Our network -->
        <div class="slide our-network-slide projects-container">
            <div class="figure-mock our-network-mock">
                <div class="our-network-image1"></div>
                <div class="our-network-image2"></div>
            </div>
            <div>
                <h3>Our network</h3>
        ...
        <div class="slide dbmc-slide projects-container">
            <div class="figure-mock dbmc-mock">
                <div class="dbmc-image1"></div>
                <div class="dbmc-image2"></div>
            </div>
            <div>
        ...
        <!-- Token Modelling Canvas -->
        <div class="slide tmc-slide projects-container">
            <div class="figure-mock tmc-mock">
                <div class="tmc-image1"></div>
                <div class="tmc-image2"></div>
            </div>
            <div>
        ...
        <!-- Blockchainz Design -->
        <div class="slide blockchainz-design-slide projects-container">
            <div class="figure-mock blockchainz-design-mock">
                <div class="blockchainz-design-image1"></div>
                <div class="blockchainz-design-image2"></div>
            </div>
            <div>
        ...
        <!-- Web3.fm  -->
        <div class="slide web3-slide projects-container">
            <div class="figure-mock web3-mock">
                <div class="web3-image1"></div>
                <div class="web3-image2"></div>
            </div>
            <div>
                <h3>Web3.fm</h3>
