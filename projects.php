...
<main>
    ...
    <!-- Scriptarnica -->
    <div class="slide scriptarnica-slide">
        <div>
            <h3>Scriptarnica</h3>
    ...
    <!-- Bizzllet -->
    <div class="slide bizzllet-slide">
        <div>
            <h3>Bizzllet</h3>
    ...
    <!-- Crypto Trophies -->
    <div class="slide crypto-trophies-slide">
        <div>
    ...
    <!-- Liquid Crystal  -->
    <div class="slide liquid-crystal-slide">
        <div>
    ...
    <!-- Our network -->
    <div class="slide our-network-slide">
        <div>
            <h3>Our network</h3>
    ...
    <!-- Blockchainz Design -->
    <div class="slide blockchainz-design-slide">
        <div>
